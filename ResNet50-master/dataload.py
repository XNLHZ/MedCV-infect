...
# 初始化根目录
train_path = 'D:/pycharm/Medical-images/MedCV/ResNet50-master/cell_data/train/total_data'
test_path = 'D:/pycharm/Medical-images/MedCV/ResNet50-master/cell_data/test/sp_kp'
...
new_train_ds = MyDataSet(train_path)

...
from resnet18.infer import sp_class_infer
        ...
        for img_src, img_path, vid_cap in tqdm(self.files):
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    cell_img = img_ori[y1:y2, x1:x2, ...]
                    sp_class = sp_class_infer(cell_img)
                    # cv2.imwrite("D:/pycharm/Medical-images/MedCV/YOLOv6/resnet18/output/2.jpg", cell_img)
                    ...
                    if save_txt:  # Write to file
                        ...
                        with open(txt_path + '.txt', 'a') as f:
                            ...
                            f.write(('%g ' * len(line)).rstrip() % line + ' ' + sp_class + '\n')
                    ...
                    if save_img:
                        ...
                        # label = None if hide_labels else (self.class_names[class_num] if hide_conf else f'{self.class_names[class_num]} {sp_class} {conf:.2f} ')

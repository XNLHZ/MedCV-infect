...
sys.path.append("/home/zccao20215227103/hcxue/MedCV/YOLOv6")
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--data-path', default='D:/pycharm/Medical-images/MedCV/YOLOv6/data/dataset.yaml', type=str, help='path of dataset')
    parser.add_argument('--conf-file', default='D:/pycharm/Medical-images/MedCV/YOLOv6/configs/yolov6s_finetune.py', type=str, help='experiments description file')
    ...
    parser.add_argument('--name', default='cloth', type=str, help='experiment name, saved to output_dir/name')
    ...
    parser.add_argument('--stop_aug_last_n_epoch', default=5, type=int, help='stop strong aug at last n epoch, neg value not stop, default 15')

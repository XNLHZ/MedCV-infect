...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='../runs/train/cloth2/weights/best_ckpt.pt', help='model path(s) for inference.')
    parser.add_argument('--source', type=str, default='../../dataset/cloth_YOLO_data/images/test', help='the source path, e.g. image-file/dir.')
    ...
    parser.add_argument('--save-txt', action='store_true', default="runs/inference/result.txt", help='save results to *.txt.')
    parser.add_argument('--save-img', action='store_false', default="runs/inference/result.png", help='save visuallized inference results.')
    parser.add_argument('--save-dir', type=str, default="../runs/cloth_inference/", help='directory to save predictions in. See --save-txt.')

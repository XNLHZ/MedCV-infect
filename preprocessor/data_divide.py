...
images = "D:/pycharm/Medical-images/MedCV/YOLOv6/cell_data/format_images/"              # 存放图片数据的路径
labels = "D:/pycharm/Medical-images/MedCV/YOLOv6/cell_data/cell_labels/"              # 存放标注数据的路径
img_out_file = "D:/pycharm/Medical-images/MedCV/YOLOv6/cell_data/images/"     # 输出划分后图片的路径

...
images = "D:/pycharm/Medical-images/MedCV/dataset/cloth_YOLO_data/total_data/img/"              # 存放图片数据的路径
labels = "D:/pycharm/Medical-images/MedCV/dataset/cloth_YOLO_data/total_data/label/"              # 存放标注数据的路径
img_out_file = "D:/pycharm/Medical-images/MedCV/dataset/cloth_YOLO_data/image/"     # 输出划分后图片的路径
label_out_file = "D:/pycharm/Medical-images/MedCV/dataset/cloth_YOLO_data/label/"   # 输出划分后标注的路径
num = 2022                                         # 图片总数

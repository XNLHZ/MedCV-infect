...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='runs/train/cloth7/weights/best_ckpt.pt', help='model path(s) for inference.')
    parser.add_argument('--source', type=str, default='../dataset/cloth_YOLO_data/normal_test/cutted/images', help='the source path, e.g. image-file/dir.')
    ...
    parser.add_argument('--yaml', type=str, default='data/cloth_dataset.yaml', help='data yaml file.')
    ...
    parser.add_argument('--save-dir', type=str, default='runs/cloth_infer/infer_cutted_test_0.35', help='directory to save predictions in. See --save-txt.')
    ...
    parser.add_argument('--project', default='runs/cloth_infer', help='save inference results to project/name.')
    parser.add_argument('--name', default='infer', help='save inference results to project/name.')

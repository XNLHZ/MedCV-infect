...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--data-path', default='./data/cloth_dataset_cutted.yaml', type=str, help='path of dataset')
    parser.add_argument('--conf-file', default='./configs/yolov6s6_finetune.py', type=str, help='experiments description file')
